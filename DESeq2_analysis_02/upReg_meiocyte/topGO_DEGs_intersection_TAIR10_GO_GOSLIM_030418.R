...
# Example usage:
# Rscript topGO_DEGs_intersection_TAIR10_GO_GOSLIM_030418.R BP res_taf4bVCol_0.01_lfcShrink_Chr_Sig0.01_downRegGeneIDs_res_meiocyteVleaf_0.01_lfcShrink_Chr_Sig0.01_upRegGeneIDs.txt 0.05
...
inDir <- "/projects/ajt200/BAM_masters/RNAseq_meiocyte_Feng/DESeq2_analysis_02/upReg_meiocyte/"
...
degGO <- function(target) {
  ...
  geneID2GO <- readMappings(file = paste0("/projects/ajt200/TAIR10/TAIR10_ATH_GO_GOSLIM_030418_geneID_GOann_reshaped.txt"))
